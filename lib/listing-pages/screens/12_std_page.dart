...
class ListingPage12Std extends StatefulWidget {
  final LoginResponse loginResponse;
  final CartData cartData;

  ListingPage12Std({this.loginResponse, this.cartData});

  @override
  _ListingPage12Std createState() =>
      _ListingPage12Std(loginResponse: loginResponse, cartData: cartData);
}

class _ListingPage12Std extends State<ListingPage12Std>
    with SingleTickerProviderStateMixin {
  final LoginResponse loginResponse;
  final CartData cartData;

  _ListingPage12Std({this.loginResponse, this.cartData});
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Image.asset(
                  'lib/assets/icons/12th standard.gif',
                  fit: BoxFit.fill,
                ),
              ),
              TabBar(
