...
class ListingPage9Std extends StatefulWidget {
  final LoginResponse loginResponse;
  final CartData cartData;

  ListingPage9Std({this.loginResponse, this.cartData});

  @override
  _ListingPage9Std createState() =>
      _ListingPage9Std(loginResponse: loginResponse, cartData: cartData);
}

class _ListingPage9Std extends State<ListingPage9Std>
    with SingleTickerProviderStateMixin {
  final LoginResponse loginResponse;
  final CartData cartData;

  _ListingPage9Std({this.loginResponse, this.cartData});
          ...
          child: Column(
            children: [
              ...
              Container(
                width: MediaQuery.of(context).size.width,
                child: Image.asset(
                  'lib/assets/icons/9th standard.png',
                  fit: BoxFit.fill,
                ),
              ),
              Padding(
                                            ...
                                            Container(
                                              ...
                                              child: MaterialButton(
                                                ...
                                                height: MediaQuery.of(context)
                                                    ...
                                                    0.02,
                                                onPressed: () {
                                                  showViewNavigator("Combos", "2","13"); // title, cat: 8th, subcat: text
                                            ...
                                            Container(
                                              ...
                                              child: MaterialButton(
                                                ...
                                                height: MediaQuery.of(context)
                                                    ...
                                                    0.02,
                                                onPressed: () {
                                                  showViewNavigator("TextBooks", "2","1");
                                                },
                                                color: Color.fromARGB(
                                                    255, 71, 54, 111),
                                                elevation: 0,
                                            ...
                                            Container(
                                              ...
                                              child: MaterialButton(
                                                ...
                                                height: MediaQuery.of(context)
                                                    ...
                                                    0.02,
                                                onPressed: () {
                                                  showViewNavigator("Helping Hands", "2","4");
                                                },
                                                color: Color.fromARGB(
                                                    255, 71, 54, 111),
                                                elevation: 0,
