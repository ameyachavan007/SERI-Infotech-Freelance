...
class ListingPage1 extends StatefulWidget {
  ...
  ListingPage1({this.loginResponse, this.cartData});

  @override
  _ListingPage1State createState() =>
      _ListingPage1State(loginResponse: loginResponse, cartData: cartData);
}
...
class _ListingPage1State extends State<ListingPage1>
  ...
  final CartData cartData;
  bool search = false;
  _ListingPage1State({this.loginResponse, this.cartData});
