...
class _CompetitiveState extends State<Competitive> {
  ...
  void initState() {
    ...
    futureForJEEProducts = productController
        .getProductBySubCategory(new ProductData(catId: "6", subCatId: "5"));
    futureForNEETProducts = productController
        .getProductBySubCategory(new ProductData(catId: "6", subCatId: "6"));
    futureForHelpingHandsProducts = productController
        .getProductBySubCategory(new ProductData(catId: "6", subCatId: "4"));
